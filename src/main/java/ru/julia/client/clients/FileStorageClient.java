...
public interface FileStorageClient {
    ...
    @RequestMapping("/transferToClient") // строит запрос для сервера
    String transferToClient(@RequestParam("clientName") String clientName, @RequestParam("fileName") String fileName);

    @PostMapping(value = "/receiveFromClient", consumes = MediaType.MULTIPART_FORM_DATA_VALUE)
    String receiveFromClient(@RequestParam("clientName") String clientName, @RequestParam("fileName") String fileName,
